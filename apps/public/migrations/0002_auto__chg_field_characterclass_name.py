...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'public_characterclass', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CharacterClass.name'
        db.alter_column(u'public_characterclass', 'name', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True))
    ...
    models = {
        ...
        u'public.encounter': {
            ...
            'characters': ('django.db.models.fields.related.ManyToManyField', [], {'default': "''", 'related_name': "'Encounter'", 'symmetrical': 'False', 'to': u"orm['public.Character']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'items': ('django.db.models.fields.related.ManyToManyField', [], {'default': "''", 'to': u"orm['public.Item']", 'symmetrical': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'unique': 'True', 'max_length': '10'}),
            'players': ('django.db.models.fields.related.ManyToManyField', [], {'default': "''", 'to': u"orm['public.Character']", 'symmetrical': 'False'})
        },
        u'public.game': {
