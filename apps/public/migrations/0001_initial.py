...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'public_game', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=50)),
            ('gamer_master', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['public.GameMaster'], unique=True)),
            ('scenario', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['public.Scenario'])),
            ('encounter', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['public.Encounter'])),
        ))
    ...
    models = {
        ...
        u'public.game': {
            ...
            'encounter': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'to': u"orm['public.Encounter']"}),
            'gamer_master': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['public.GameMaster']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'unique': 'True', 'max_length': '50'}),
            'players': ('django.db.models.fields.related.ManyToManyField', [], {'default': "''", 'to': u"orm['public.Player']", 'symmetrical': 'False'}),
        ...
        u'public.scenario': {
            ...
            'encounters': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['public.Encounter']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'unique': 'True', 'max_length': '50'})
        },
        u'public.skill': {
