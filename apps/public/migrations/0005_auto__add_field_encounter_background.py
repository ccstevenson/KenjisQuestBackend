...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Encounter.background'
        db.add_column(u'public_encounter', 'background',
                      self.gf('django.db.models.fields.CharField')(default='../img/cave.png', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Encounter.background'
        db.delete_column(u'public_encounter', 'background')
    ...
    models = {
        ...
        u'public.character': {
            ...
            'damage': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30'}),
        ...
        u'public.encounter': {
            ...
            'background': ('django.db.models.fields.CharField', [], {'default': "'../img/cave.png'", 'max_length': '200'}),
