...
urlpatterns = patterns('apps.public.views',
    ...
    url(r'^character-classes$', CharacterClassList.as_view(), name='character-class-list'),
    url(r'^character-class/(?P<pk>[0-9]+)$', CharacterClassDetail.as_view(), name='character-class-detail'),
    url(r'^create-character-class$', CreateCharacterClass.as_view(), name='create-character-class'),
    ...
    url(r'^encounters$', EncounterList.as_view(), name='encounter-list'),
    url(r'^encounter/(?P<pk>[0-9]+)$', EncounterDetail.as_view(), name='encounter-detail'),
    url(r'^create-encounter$', CreateEncounter.as_view(), name='create-encounter'),
